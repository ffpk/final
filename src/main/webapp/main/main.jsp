                ...
                success: function (data) {
                   // console.log(data)
                    $.each(data, function (index, first) {
                        ...
                        var c = "";
                        $.each(first.menuslist, function (index1, second) {

                            c += "<div style='text-align: center'><a  class='easyui-linkbutton' data-options=\"iconCls:'icon-tip',plain:true\" onclick=\"addTabs('" + second.title + "','" + second.url + "','" + second.iconCls + "')\">" + second.title + "</a></div>";
                        })
                        $('#aa').accordion('add', {
                            title: first.title,
                            content: c,
